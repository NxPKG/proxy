...
int main(int /* argc */, char** argv) {
  ...
  if (pid == 0) {
    ...
    RELEASE_ASSERT(Envoy::Khulnasoft::PrivilegedService::get_capabilities(CAP_EFFECTIVE) == 0 &&
                       Envoy::Khulnasoft::PrivilegedService::get_capabilities(CAP_PERMITTED) == 0 &&
