...
public:
  KhulnasoftTcpProxyIntegrationTest()
      : KhulnasoftTcpIntegrationTest(fmt::format(
            TestEnvironment::substitute(khulnasoft_tcp_proxy_config_fmt, GetParam()), "true")) {}
};
...
public:
  KhulnasoftGoLinetesterIntegrationTest()
      : KhulnasoftTcpIntegrationTest(fmt::format(
            TestEnvironment::substitute(khulnasoft_linetester_config_fmt, GetParam()), "true")) {}
...
public:
  KhulnasoftGoBlocktesterIntegrationTest()
      : KhulnasoftTcpIntegrationTest(fmt::format(
            TestEnvironment::substitute(khulnasoft_blocktester_config_fmt, GetParam()), "true")) {}
