...
public:
  KhulnasoftTLSProxyIntegrationTest()
      : KhulnasoftTLSIntegrationTest(fmt::format(
            TestEnvironment::substitute(khulnasoft_tls_tcp_proxy_config_fmt, GetParam()), "true")) {}
...
public:
  KhulnasoftDownstreamTLSIntegrationTest()
      : KhulnasoftTLSIntegrationTest(fmt::format(
            TestEnvironment::substitute(khulnasoft_tls_downstream_tcp_proxy_config_fmt, GetParam()),
            "true")) {}
