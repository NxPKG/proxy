...
public:
  KhulnasoftIntegrationTest()
      : KhulnasoftHttpIntegrationTest(
            fmt::format(TestEnvironment::substitute(khulnasoft_proxy_config_fmt, GetParam()), "true")) {
  }
...
TEST_P(KhulnasoftIntegrationPortTest, DuplicatePort) {
  initialize();
...
public:
  KhulnasoftIntegrationEgressTest()
      : KhulnasoftIntegrationTest(fmt::format(
            TestEnvironment::substitute(khulnasoft_proxy_config_fmt, GetParam()), "false")) {
